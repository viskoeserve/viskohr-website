    ...
    <div class="col-lg-6 d-flex flex-column justify-content-center fadeInLeft">
      ...
      {/* <div data-aos="fade-up" data-aos-delay="600">
        <div class="text-center text-lg-start">
          ...
          <a href="https://apps.apple.com/in/app/remark-job-recruiter-app/id6475642568" class="btn-get-started scrollto d-inline-flex align-items-center  align-self-center" style={{backgroundColor:"#115E59"}}>
            <span >Download from Appstore</span>
            <i class="fa fa-arrow-right" style={{color:"white"}}></i>
          </a>
        </div>
      ...
      <div data-aos="fade-up" data-aos-delay="600">
  <div class="text-center text  -start d-flex justify-content-center" style={{ gap: "5px" }}>
    <a 
      href="https://apps.apple.com/in/app/remark-job-recruiter-app/id6475642568" 
    ...
    <a 
      ...
      class="btn-get-started scrollto d-inline-flex align-items-center align-self-center" 
      style={{ backgroundColor: "#115E59" }}
    >
